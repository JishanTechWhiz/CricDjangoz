...
class a5(admin.ModelAdmin):
    list_display = ['id','userId','team_id','team_id2','ground_id','match_type','noOfOvers','overPerBowler','city','dateTime','ballType','pitchType']
...
class a8(admin.ModelAdmin):
    list_display = ['id','userId','tournamentName','city','groundId','organizerName','organizerNum','organizerEmail','startDate','endDate','tournamentCat','ballType','pitchType','description']
...
class a12(admin.ModelAdmin):
    list_display = ['id', 'user', 'ground', 'date', 'time_slot', 'status', 'price']
...
admin.site.register(Booking, a12)
